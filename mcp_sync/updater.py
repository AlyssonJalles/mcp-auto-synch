...
def restart_app() -> None:
    ...
    # Drop the single-instance claim first: the successor starts while this
    # process is still alive, and would otherwise find the slot taken, decide
    # an instance is already running, and exit - leaving nothing running at
    # all. Releasing here rather than relying on process exit closes that race.
